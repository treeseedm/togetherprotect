...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColorSelect = Color.parseColor("#c70000");
    ...
    public void updateTextColor(int position) {
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                TextView tab = (TextView) v;
//                tab.setTextColor(0 == i ? tabTextColorSelect:tabTextColor);//default 0 select
                tab.setTextColor(position == i ? tabTextColorSelect : tabTextColor);
